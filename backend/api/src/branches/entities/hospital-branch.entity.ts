...
export class HospitalBranchEntity {
  @PrimaryGeneratedColumn({ type: 'bigint', name: 'branch_id' })
  branchId: number;

  @Column({ type: 'varchar', length: 100, name: 'branch_name' })
  branchName: string;

  @Column({ type: 'varchar', length: 200, name: 'branch_address', nullable: true })
  branchAddress?: string;

  @Column({ type: 'varchar', length: 20, name: 'branch_phone', nullable: true })
  branchPhone?: string;
